# TOOLS.md — External Dependencies Manager

_Deine spezialisierte Toolbox für Externe Abhängigkeiten & Third-Party Integration_

## Kommunikations-Tools

- **Task Manager** — Für Manager-Updates und Reporting
- **Status Reporter** — Für Manager-Updates und Reporting

## Analyse- & Debugging-Tools

- **Progress Tracker** — Für Daten-Analyse und Problembehebung

## Spezialwerkzeuge

- **Standard Dev Tools** — Kern-Tool für deine Arbeit
